...
var createScene = function () {
    ...
    var browsers_Series = [
        { label: "Mjau", value: 32, color: new BABYLON.Color3(0, 0, 1) },
        { label: "Meh", value: 28, color: new BABYLON.Color3(1, 0, 0) },
        { label: "Hemx", value: 16, color: new BABYLON.Color3(1, 0, 1) },
        { label: "Kekeke", value: 14, color: new BABYLON.Color3(1, 1, 0) },
        { label: "Mewu", value: 10, color: new BABYLON.Color3(0, 1, 1) }        
    ];
    ...
    backgroundTexture.drawText("- Cats in the sky -", null, 250, "35px Segoe UI", "white", null);
