...
var animateScene = function () {
    ...
    for ( var i = 0; i < intersects.length; i++ ) {
        var r = Math.floor(intersects[ i ].object.rotation.x * 100)
        var g = Math.floor(intersects[ i ].object.rotation.y * 100)
        var b = Math.floor(intersects[ i ].object.rotation.z * 100)
        intersects[ i ].object.material.color.set( 0x+r+g+f );
